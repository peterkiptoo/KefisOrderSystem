        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="./reorders.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-project-diagram me-2"></i>Pending Reorders</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Sales Dashboard</h2>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                 <h3 class="fs-4 mb-3">Product Listing</h3>
                    <div class="col">
                ...
                $query = 'SELECT * FROM products';
                    $result = mysqli_query($db, $query) or die (mysqli_error($db));
                        ...
                        if(isset($_POST['Submit']))
                            {
                          $sql = 'UPDATE products SET quantity=quantity-1 WHERE id='. $row['id'].'';
                          if (mysqli_query($db, $sql)) {
                              
                           if($row['quantity'] < $row['reorder_level']){
                             echo'low stock';
                               $sql = "INSERT INTO reorders (name, quantity, price,isprocessed)
                                  VALUES ('{$row['name']}', '{$row['quantity']}', '{$row['price']}','0')";
                        ...
                        <button type="submit" class="btn btn-lg btn-warning " name="Submit" style="width:140px;">Sell</button>
                         </form>
                    </div>
                </div>
                <?php
